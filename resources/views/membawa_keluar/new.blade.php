                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_penuh_penerima"
                                                    placeholder="Nama penuh penerima" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="ic_passport_penerima"
                                                    placeholder="NRIC/passport penerima" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="alamat_destinasi"
                                                    placeholder="Alamat destinasi penghantaran" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_lokasi_pihak_berkuasa"
                                                    placeholder="Nama lokasi pihak berkuasa pengimport" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="butir_ringkas_pengurungan_pengaturan"
                                                    placeholder="Nyatakan bagaimana pengaturan barang yang hendak dibawa keluar" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
        ...
        $('#btnSubmit').click(function(e) {
            ...
            if ($('#formPermit').parsley().isValid()) {
                ...
                if(confirm("Adakah anda pasti untuk menghantar borang ini?")){
                    ...
                    $.ajax({
                        type: "post",
                        url: "/permit/membawakeluar/postSubmit",
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "JSON",
