...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Permit Membawa Keluar Haiwan DLL</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/permit/membawakeluar">Bawa Keluar</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-6">
                                        <h5 class="m-0">BORANG 22 (Peraturan 49(1))</h5>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="/permit/membawakeluar" class="btn btn-warning float-right">Kembali</a>
                                    </div>
                                </div>
                            </div>
                            <form id="formPermit" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <br>
                                    <div class="row">
                                        <div class="col-md-12"><h4><u>Maklumat Penerima</u></h4></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nama Penuh</label>
                                                <input type="text" class="form-control" name="nama_penuh_penerima"
                                                    placeholder="Nama penuh penerima" value="{{ $data->nama_penuh_penerima ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>NRIC/Passport</label>
                                                <input type="text" class="form-control" name="ic_passport_penerima"
                                                    placeholder="NRIC/passport penerima" value="{{ $data->ic_passport_penerima ?? '' }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Salinan NRIC/Passport</label>
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input" id="salinan_ic_passport"
                                                        name="salinan_ic_passport[]" multiple>
                                                    <label class="custom-file-label" for="salinan_ic_passport">Choose
                                                        file</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12" id="petaFailAttachment">
                                            <div class="card-footer bg-white">
                                                <ul class="mailbox-attachments d-flex align-items-stretch clearfix">
                                                    @foreach ($salinan_ic_passport as $item)
                                                        <li>
                                                            {{-- <span class="mailbox-attachment-icon"><i class="fas fa-file-text-o"></i></span> --}}
                                                            <div class="mailbox-attachment-info">
                                                                <a href="/permit/membawakeluar/download/{{ basename($item->file_name) }}"
                                                                ...
                                                                <span class="mailbox-attachment-size">
                                                                    ...
                                                                    @if (in_array($data->status_borang_id,array(3,7,8)))
                                                                        <a href="/permit/membawakeluar/deletefile/{{ $item->id }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Alamat destinasi penghantaran</label>
                                                <input type="text" class="form-control" name="alamat_destinasi"
                                                    placeholder="Alamat destinasi penghantaran" value="{{ $data->alamat_destinasi ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Negara Pengimport</label>
                                                <select id="negara_pengimport_id" name="negara_pengimport_id" style="width: 100%" required>
                                                    <option value="">Sila Pilih</option>
                                                    @foreach ($negara as $item)
                                                    <option value="{{ $item->id }}" @if ($item->id == $data->negara_pengimport_id)
                                                        selected
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Pihak Berkuasa Pengimport</label>
                                                <input type="text" class="form-control" name="pihak_berkuasa_pengimport"
                                                    placeholder="Nama jabatan pihak berkuasa pengimport"
                                                    value="{{ $data->pihak_berkuasa_pengimport ?? '' }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Nama Lokasi</label>
                                                <input type="text" class="form-control" name="nama_lokasi_pihak_berkuasa"
                                                    placeholder="Nama lokasi pihak berkuasa pengimport"
                                                    value="{{ $data->nama_lokasi_pihak_berkuasa ?? '' }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12"><h4><u>Maklumat Barang Dibawa Keluar</u></h4></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Jenis Barang Dibawa Keluar</label>
                                                <select id="jenis_dibawa_keluar_id" name="jenis_dibawa_keluar_id" style="width: 100%" required>
                                                    <option value="">Sila Pilih</option>
                                                    @foreach ($jenis as $item)
                                                        <option value="{{ $item->id }}" @if ($item->id == $data->jenis_dibawa_keluar_id)
                                                            selected
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Butir ringkas pengurungan / pengaturan</label>
                                                <input type="text" class="form-control" name="butir_ringkas_pengurungan_pengaturan"
                                                    placeholder="Nyatakan bagaimana pengaturan barang yang hendak dibawa keluar"
                                                    value="{{ $data->butir_ringkas_pengurungan_pengaturan ?? '' }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12"><h4><u>Senarai Barang Dibawa Keluar</u></h4></div>
                                    </div>
                                    @if (in_array($data->status_borang_id,array(3,7,8)))
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <tbody>
                                                    @foreach ($senarai_dibawa as $item)
                                                        <tr>
                                                            ...
                                                            <td>{{ $item->jenis_dibawa_keluar ?? '' }}</td>
                                                            <td>{{ $item->spesis ?? '' }}</td>
                                                            <td>{{ $item->bilangan ?? '' }}</td>
                                                            <td>{{ $item->berat ?? '' }}</td>
                                                            <td>{{ $item->tanda ?? '' }}</td>
    ...
    <!-- /.content-wrapper -->
    @include('membawa_keluar.add_item_new')
    @push('script')
    <script>
        $(function() {
            //Datepicker
            ...
            $('#negara_pengimport_id').select2();
            $('#jenis_dibawa_keluar_id').select2();
            $('#jenis_dibawa_keluar_new_id').select2();
        ...
        $('#btnAddBarang').click(function (e) {
            ...
            $('#jenis_dibawa_keluar_new_id').val(null).trigger('change');
        ...
        $('#btnTambahSpesiesModal').click(function (e) {
            ...
            $('#tableBarang').DataTable().row.add([
                '',
                $('#jenis_dibawa_keluar_new_id').val(),
                $('#spesis_new_id').val(),
                $('#bilangan_new').val(),
                $('#berat_new').val(),
                $('#tanda_new').val(),
        ...
        $('#tableBarang').on('click', '.btnDeleteSenaraiBarang', function () {
            if(confirm("Adakah anda pasti untuk hapuskan rekod ini? Rekod dalam database juga akan dihapuskan. Klik OK untuk hapuskan")){
                ...
                $.ajax({
                    type: "POST",
                    url: "/permit/membawakeluar/postDeleteSpesis",
                    data: {
        ...
        $('#btnUpdate').click(function(e) {
            ...
            if ($('#formPermit').parsley().isValid()) {
                ...
                if(confirm("Adakah anda pasti untuk menghantar borang ini?")){
                    ...
                    $.ajax({
                        type: "post",
                        url: "/permit/membawakeluar/postUpdate",
                        data: formData,
                        contentType: false,
                        processData: false,
                        dataType: "JSON",
                        success: function(response) {
                            ...
                            window.location.href = "/permit/membawakeluar";
                        }
                    });
                }
            }
        ...
        $('#btnReturn').click(function (e) {
            ...
            if(confirm("Adakah anda pasti untuk mengembalikan borang permohonan ini kepada pemohon? Klik OK untuk setuju")){
                ...
                if(comment != null){
                    $.ajax({
                        type: "POST",
                        url: "/permit/membawakeluar/postReturn",
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
        ...
        $('#btnSahkan').click(function(e) {
                ...
                if (confirm('Adakah anda pasti untuk sahkan borang permit ini?')) {
                    $.ajax({
                        type: "post",
                        url: "/permit/membawakeluar/postSahkanBorang",
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            borang_id: $('#borangId').val(),
                        },
            ...
            $('#btnApprove').click(function(e) {
                ...
                if (confirm('Adakah anda pasti untuk luluskan borang permit ini?')) {
                    $.ajax({
                        type: "post",
                        url: "/permit/membawakeluar/postApproveBorang",
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            borang_id: $('#borangId').val(),
                        },
            ...
            $('#btnReject').click(function(e) {
                ...
                if (confirm('Adakah anda pasti untuk tolak/reject borang permit ini?')) {
                    $.ajax({
                        type: "post",
                        url: "/permit/membawakeluar/postRejectBorang",
                        data: {
                            _token: $('meta[name="csrf-token"]').attr('content'),
                            borang_id: $('#borangId').val(),
                        },
