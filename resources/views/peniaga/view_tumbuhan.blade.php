                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="no_tel" placeholder="Contoh: 014-3332020"
                                            value="{{ $borang->no_tel_hp ?? '' }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="alamat_premis" placeholder="Alamat premis berkenaan dengan mana permit diminta"
                                            value="{{ $borang->alamat_premis ?? '' }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>5. Bilangan Pekerja</label>
                                            <input type="text" class="form-control" name="jumlah_pekerja" placeholder="Contoh: 5 orang"
                                            value="{{ $borang->jumlah_pekerja ?? '' }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jenis_tumbuhan_diniaga" placeholder="Contoh: Bunga orkid"
                                            value="{{ $borang->jenis_tumbuhan_diniaga ?? '' }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="butir_lesen_permit_terdahulu"
                                            value="{{ $borang->butir_lesen_permit_terdahulu ?? '' }}" placeholder="Permit yang dipegang dan permit-permit peniaga yang terdahulu" required>
                                        </div>
                                    </div>
                                </div>
                                @php
                                    $tarikhPenyataTerakhir = '';
                                    if ($borang->tarikh_penyata_terakhir) {
                                        $tarikhPenyataTerakhir = date_format(date_create($borang->tarikh_penyata_terakhir), 'd/m/Y');
                                    }
                                @endphp
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="tarikh_penyata_terakhir_div" data-target-input="nearest">
                                                <input type="text" name="tarikh_penyata_terakhir" placeholder="dd/mm/yyyy" class="form-control datetimepicker-input"
                                                value="{{ $tarikhPenyataTerakhir ?? '' }}" data-target="#tarikh_penyata_terakhir_div">
                                                ...
                                                @foreach ($fail_permit_perniagaan as $item)
                                                    <li>
                                                        ...
                                                        <div class="mailbox-attachment-info">
                                                            <a href="/permit/peniaga/download/tumbuhan/{{ basename($item->file_name) }}"
                                                                class="mailbox-attachment-name"><i
                                                                    class="fas fa-paperclip"></i>
                                                                {{ basename($item->original_name) }}</a>
                                                            <span class="mailbox-attachment-size">
                                                                {{ $item->file_size }}KB
                                                                <a href="/permit/peniaga/deletefile/tumbuhan/{{ $item->id }}"
...
<script>
    ...
    $('#btnSubmit').click(function(e) {
        ...
        if ($('#formPermit').parsley().isValid()) {
            ...
            $.ajax({
                type: "POST",
                url: "/permit/peniaga/postUpdatePeniagaTumbuhan",
