...
<html>
<head>
<title>Permit Peniaga Tumbuhan</title>
<style type="text/css">
.center-align {
	text-align: center;
}
...
<p class="center-align"><span class="times-roman">BORANG 19</span><br class="times-roman">
<span class="times-roman">(Peraturan 44(2))</span></p>
<p class="times-roman-center">NEGERI SABAH</p>
<p class="times-roman-center">ENAKMEN PERLINDUNGAN HIDUPAN LIAR 1997</p>
<p class="times-roman-center">PERMIT PENIAGA TUMBUHAN</p>
...
<p class="left-align">(Nama) <span class="underline">&nbsp;{{$nama ?? ''}}</span>
    ...
    <span class="underline">&nbsp;{{$alamat_premis ?? ''}}&nbsp;</span> bagi tumbuhan liar yang dinyatakan
    di bawah:
    </p>
...
<p class="left-align">&nbsp;</p>
<p class="left-align">Permit ini sah sehingga 31 December pada tahun ia dikeluarkan.</p>
