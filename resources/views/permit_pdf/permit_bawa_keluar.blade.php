...
<html>
<head>
<title>Permit Membawa Keluar</title>
<style type="text/css">
.center-align {
	text-align: center;
}
...
<p class="center-align"><span class="times-roman">BORANG 23</span><br class="times-roman">
<span class="times-roman">(Peraturan 49(3))</span></p>
<p class="times-roman-center">NEGERI SABAH</p>
<p class="times-roman-center">ENAKMEN PEMELIHARAAN HIDUPAN LIAR 1997</p>
<p class="times-roman-center">PERMIT UNTUK MEMBAWA HAIWAN DLL. KELUAR DARI NEGERI</p>
...
<p class="left-align">(Nama &amp; No. Kad Pengenalan) <span class="underline">&nbsp;{{$nama ?? ''}}&nbsp;({{$ic ?? ''}})&nbsp;</span>
    ...
    adalah dibenarkan untuk membawa keluar dari Negeri haiwan/hasil haiwan/
tumbuhan/ hasil tumbuhan yang disenaraikan dalam Jadual di bawah setelah memuaskan hati Pengarah
Hidupan Liar bahawa haiwan/ hasil haiwan/ tumbuhan/ hasil tumbuhan itu di bawa keluar menurut
Enakmen Pemeliharaan Hidupan Liar 1997 dan Konvensyen Perdagangan Antarabangsa Spesies Terancam
Fauna dan Flora Liar (CITES) dan bahawa dalam kes haiwan hidup kemudahan-kemudahan yang wajar dan
mencukupi akan disediakan bagi persinggahan haiwan tersebut supaya memastikan bahawa risiki kecederaan,
kerosakan kepada kesihatan atau layanan kejam ke atas haiwan tersebut dapat dikurangkan.
    </p>
    ...
    @if ($listHasil)
        ...
        <table align="center" style="width: 90%">
            <tr>
                ...
                <td><span class="underline">Berat</span></td>
                <td><span class="underline">Tanda (jika ada)</span></td>
            </tr>
