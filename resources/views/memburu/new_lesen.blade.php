...
<div class="content-wrapper">
                    ...
                    <form id="lesenForm">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="daerah_memburu_id" name="daerah_memburu_id"
                                                data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                                <option value="">Pilih</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="kawasan_memburu" id="kawasan_memburu" maxlength="50" class="form-control"
                                                placeholder="Nama kawasan memburu" value="" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control float-right" id="tempoh_memburu" name="tempoh_memburu" required autocomplete="off" data-parsley-error-message="<p class='text-red'>Diperlukan!</p>">
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="No pendaftaran kereta" id="no_pendaftaran_kereta"
                                                name="no_pendaftaran_kereta" value="" data-parsley-error-message="<p class='text-red'>Diperlukan!</p>"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Nyatakan alamat kediaman di Sabah" id="alamat_kediaman"
                                                name="alamat_kediaman" value="" data-parsley-error-message="<p class='text-red'>Diperlukan!</p>"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th>No. Lesen Senjata Api</th>
                                                </tr>
                                                <tr>
                                                    <td>1</td>
                                                    <td><input type="text" class="form-control" placeholder="" id="nama_teman_1" name="nama_teman_1"
                                                            value=""></td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_kp_1" name="no_kp_1" value="">
                                                    </td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_lesen_senjata_teman1"
                                                            name="no_lesen_senjata_teman1" value="">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td><input type="text" class="form-control" placeholder="" id="nama_teman_2" name="nama_teman_2"
                                                            value=""></td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_kp_2" name="no_kp_2" value="">
                                                    </td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_lesen_senjata_teman2"
                                                            name="no_lesen_senjata_teman2" value="">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td><input type="text" class="form-control" placeholder="" id="nama_teman_3" name="nama_teman_3"
                                                            value=""></td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_kp_3" name="no_kp_3" value="">
                                                    </td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_lesen_senjata_teman3"
                                                            name="no_lesen_senjata_teman3" value="">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    <td><input type="text" class="form-control" placeholder="" id="nama_teman_4" name="nama_teman_4"
                                                            value=""></td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_kp_4" name="no_kp_4" value="">
                                                    </td>
                                                    <td><input type="text" class="form-control" placeholder="" id="no_lesen_senjata_teman4"
                                                            name="no_lesen_senjata_teman4" value="">
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>9. Butir-butir senjata api yang dipegang dan ingin digunakan bagi memburu di bawah lesen
                                            yang dipohon</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Buatan *</label>
                                            <input type="text" class="form-control" placeholder="Contoh: Thailand" id="buatan" name="buatan"
                                             @if($butiran_senjata)
                                                value="{{$butiran_senjata->buatan}}"
                                             @else
                                                value=""
                                             @endif
                                                data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Contoh: 25mm" id="ukuran_garis_pusat"
                                                name="ukuran_garis_pusat" @if ($butiran_senjata) value="{{$butiran_senjata->ukuran_garis_pusat}}" @else
                                                value="" @endif data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Serial *</label>
                                            <input type="text" class="form-control" placeholder="Contoh: 112233" id="serial" name="serial"
                                            @if($butiran_senjata)
                                                value="{{$butiran_senjata->no_serial}}"
                                            @else
                                                value=""
                                            @endif
                                                data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="No lesen senjata api" id="no_lesen_senjata"
                                                name="no_lesen_senjata" @if ($butiran_senjata) value="{{$butiran_senjata->no_lesen_senjata_api}}" @else
                                                value="" @endif data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="tarikh_pengeluaran_div" data-target-input="nearest">
                                                <input type="text" name="tarikh_pengeluaran" name="tarikh_pengeluaran" placeholder="dd/mm/yyyy"
                                                    class="form-control datetimepicker-input" data-target="#tarikh_pengeluaran_div"
                                                    @if($butiran_senjata)
                                                        value="{{$butiran_senjata->tarikh_pengeluaran}}"
                                                    @else
                                                        value=""
                                                    @endif
                                                        data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                                <div class="input-group-append" data-target="#tarikh_pengeluaran_div" data-toggle="datetimepicker">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Contoh: Pnom Penh" id="tempat_pengeluaran"
                                                name="tempat_pengeluaran"
                                                @if ($butiran_senjata)
                                                    value="{{$butiran_senjata->tempat_pengeluaran}}"
                                                @else
                                                    value=""
                                                @endif
                                                data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group form-inline">
                                            ...
                                            <div class="radio">
                                                <label><input type="radio" name="syarat_lesen_senjata" value="Memburu" checked>&nbsp;
                                                    Memburu</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <dd>(Pemohon akan dikehendaki untuk mengemukanakan lesen senjata api sebelum pemberian lesen
                                            memburu
                                            & boleh dikehendaki
                                            untuk mengemukakan senjata api yang berkaitan)</dd>
                                        <dd>(Pemohon dikehendaki membawa surat kebenaran daripada pemilik tanah yang ingin diburu. Sila
                                            rujuk senarai semak
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>12. Senaraikan di bawah spesies, bilangan dan kawasan yang mana lesen atau lesen-lesen
                                            diminta. *</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>13. Dalam kes lesen memburu komersil, nyatakan berapa banyak haiwan ditangkap dan dengan
                                            cara apa.</label>
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="button" id="btnTambbahSpesies13" class="btn btn-primary btn-xs" data-toggle="modal"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="kawasan_ditangkap" id="kawasan_ditangkap"
                                                placeholder="nama kawasan" value="">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="soalan_ephl_id" name="soalan_ephl_id" required
                                            @if(Auth::user()->role=='client')
                                                disabled
                                            @endif>
                                                <option value="">Pilih</option>
                                            ...
                                            <input type="text" class="form-control" id="jawapan_ephl" name="jawapan_ephl" value=""
                                                data-parsley-error-message="<p class='text-red'>Diperlukan!</p>" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="tarikh_ulasan_dipohon_div" data-target-input="nearest">
                                                <input type="text" name="tarikh_ulasan_dipohon" name="tarikh_ulasan_dipohon" placeholder="dd/mm/yyyy" class="form-control datetimepicker-input" data-target="#tarikh_ulasan_dipohon_div">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="tarikh_ulasan_diterima_div" data-target-input="nearest">
                                                <input type="text" name="tarikh_ulasan_diterima" name="tarikh_ulasan_diterima" placeholder="dd/mm/yyyy"
                                                    class="form-control datetimepicker-input" data-target="#tarikh_ulasan_diterima_div">
    ...
    @include('memburu.new_lesen_modals')
...
<script>
    ...
    function SaveSpecies($borangID){
        ...
        $.ajax({
            ...
            type: 'post',
            data: {_token: $('meta[name="csrf-token"]').attr('content'), spc: tableSpeciesBuruan, borang_id: $borangID, spc_komersil: tableSpeciesBuruanKomersil},
            dataType: 'JSON',
    ...
    function addSpeciesTableRow(response){
        ...
        if(response.spesies2){
            $.each(response.spesies2, function(i,data){
                var editButton = '';
                var deleteButton = '';
                editButton = '<button type="button" class="btn btn-xs btn-warning btnEditRow13" data-id="'+data.id+'"'
                    +'data-nama_spesies="'+data.spesies+'" data-bilangan_spesies="'+data.bilangan_angka_perkataan+'"'
                    +'data-cara_tangkapan="'+data.cara_tangkapan+'" data-toggle="modal" data-target="#modal-edit-spesies13"><i '
                    +'class="fas fa-pen"></i></button>';
                deleteButton = '<button type="button" class="btn btn-xs btn-danger btnDeleteRow13" data-id="'+data.id+'"><i '
                    +'class="fas fa-trash"></i></button>';
    ...
    $('#btnTambahSpesies13Modal').click(function(e){
        ...
        if($('#nama_spesies13').val()!=='' && $('#bilangan_spesies13').val()!=='' && $('#cara_tangkapan13').val()!==''){
            ...
            +'<td>'
                +'<button type="button" data-id="" data-nama_spesies="'+$('#nama_spesies13').val()+'" data-bilangan_spesies="'+$('#bilangan_spesies13').val()+'" data-cara_tangkapan="'+$('#cara_tangkapan13').val()+'" class="btn btn-xs btn-warning btnEditRow13" data-target="#modal-edit-spesies13" data-toggle="modal"><i class="fas fa-pen"></i></button>'
    ...
    $("#tblSpesies13").on("click", ".btnDeleteRow13", function() {
        if(confirm('Anda pasti untuk delete rekod ini?')){
            ...
            if($('#tblSpesies13 tr').length==1){//add tiada rekod
                $('#tblSpesies13 tbody').append('<tr><td colspan="7" style="text-align:center">Tiada Rekod</td></tr>');
            }
        }
    });
        ...
        if(proceed=='No'){
            ...
            if(confirm("Anda pasti untuk hantar borang ini sekarang?")){
                if($('#lesenForm').parsley().isValid()){
                    ...
                    $.ajax({
                        url: '/lesen/memburu/new/postSaveSubmit',
                        type: 'post',
    ...
    $('#btnSaveDraft').click(function(e){
        ...
        if(proceed=='No'){
            ...
            if($('#lesenForm').parsley().isValid()){
                ...
                $.ajax({
                    url: '/lesen/memburu/new/postSaveDraftNew',
                    type: 'post',
                    data: $('#lesenForm').serialize() + '&soalan_ephl_id=' + $('#soalan_ephl_id').val(),
                    dataType: 'JSON',
                    success: function (response) {
                        if(response.result == 'success'){
                            ...
                            $("#nama_penuh").prop( "disabled", true );
                            $("#no_kp").prop( "disabled", true );
                            $('#soalan_ephl_id').prop( "disabled", true );
                        }
                    }
                });
            }
