                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="bil_peluru13" name="bil_peluru13"
                                    required="" placeholder="(nombor sahaja)" maxlength="5"
                                    data-parsley-error-message="<p class='text-red'>Diperlukan!</p>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Bilangan Peluru Digunakan</label>
                                <input type="text" class="form-control" id="edit_bil_peluru13" name="edit_bil_peluru13"
                                    required="" placeholder="(nombor sahaja)" maxlength="5"
                                    data-parsley-error-message="<p class='text-red'>Diperlukan!</p>">
                            </div>
                        </div>
...
{{--
<!-- MODAL DELETE SAKSI -->
<div class="modal fade in" id="modal-delete-saksi">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span></button>
                <h4 class="modal-title">Delete Rekod Saksi</h4>
            </div>
            <form method="POST" id="deleteSaksiForm">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-1">
                        ...
                        <div class="col-md-11">
                            {{ csrf_field() }}
{{ method_field('DELETE') }}
<input type="hidden" id="saksi_id" name="saksi_id" value="">
<input type="hidden" id="penguatkuasaan_id_delete_saksi" name="penguatkuasaan_id" value="{{ $penguatkuasaanID }}">
<p>Adakah anda pasti untuk DELETE rekod saksi ini? Rekod yang telah dihapuskan tidak
...
<div class="modal-footer">
    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
    <button type="submit" class="btn btn-danger btn-submit-delete-saksi">Delete</button>
</div>
</form>
</div>
</div>
