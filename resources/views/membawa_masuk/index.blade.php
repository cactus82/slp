...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Permit Membawa Masuk</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/penguatkuasaan">Permit Membawa Masuk</a></li>
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="/permit/membawamasuk/baru" id="btnBaru" class="btn btn-primary float-right"><i
...
@include('membawa_masuk.resit_am_modal');
@include('membawa_masuk.permit_file_modal');
...
<script>
    ...
    function fillDataTable() {
        ...
        //Send ajax requests
        $.ajax({
            url: '/permit/membawamasuk/loadBorang',
            type: 'POST',
            data: {
    ...
    function addDataTableRow(response) {
        ...
        $.each(response.result, function(i, data) {
            var viewButton = '<a href="/permit/membawamasuk/view/' + data.id +
            ...
            if (data.status_borang_id == 5 && data.resit_am_id) {
                generatePDF =
                    '<a type="button" target="_blank" data-toggle="tooltip" data-placement="top" title="Generate Permit" class="btn btn-default btn-sm" href="/permit/bawamasuk/pdf/' +
    ...
    $('#tablePermit').on("click", ".btnDeletePermit", function() {
        if (confirm('Adakah anda pasti untuk hapuskan borang ini? Klik OK untuk hapuskan sekarang')) {
            ...
            //Send ajax requests
            $.ajax({
                url: '/permit/membawamasuk/postDeleteBorang',
                type: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    borang_id: row_id,
    ...
    $('#btnSaveResitAm').click(function(e) {
        ...
        if ($('#resitAmForm').parsley().isValid()) {
            ...
            //Send ajax requests
            $.ajax({
                url: '/permit/membawamasuk/postUpdateResitAm',
                type: 'POST',
    ...
    $('#tablePermit').on("click", ".btnRenewPermit", function() {
        if (confirm('Adakah anda pasti untuk renew permohonan ini?')) {
            ...
            //Send ajax requests
            $.ajax({
                url: '/permit/membawamasuk/postRenewPermit',
                type: 'POST',
                data: {
                    _token: $('meta[name="csrf-token"]').attr('content'),
                    permit_id: row_id,
