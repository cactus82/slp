...
class BorangPermitPeniagaDagingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('borang_permit_peniaga_daging', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('jenis_perniagaan_daging_id')->nullable();
            $table->string('jenis_daging_didagang')->nullable();
            $table->string('butir_lesen_permit_terdahulu')->nullable();
            $table->string('butir_lesen_permit_lain')->nullable();
    ...
    {
        Schema::dropIfExists('borang_permit_peniaga_daging');
    }
}
