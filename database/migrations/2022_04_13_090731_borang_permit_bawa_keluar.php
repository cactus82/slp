...
class BorangPermitBawaKeluar extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {   //edit this
        Schema::create('borang_permit_bawa_keluar', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('nama_penuh_penerima')->nullable();
            $table->string('ic_passport_penerima')->nullable();
            $table->integer('salinan_ic_passport_id')->nullable();
            $table->string('alamat_destinasi')->nullable();
            $table->integer('negara_pengimport_id')->nullable();
            $table->string('pihak_berkuasa_pengimport')->nullable();
            $table->string('nama_lokasi_pihak_berkuasa')->nullable();
            $table->integer('jenis_dibawa_keluar_id')->nullable();
            $table->string('butir_ringkas_pengurungan_pengaturan')->nullable();
            //list table for jenis barang
            //columns: id, jenis_barang, spesis, bilangan, berat, tanda
    ...
    {
        Schema::dropIfExists('borang_permit_bawa_keluar');
    }
}
