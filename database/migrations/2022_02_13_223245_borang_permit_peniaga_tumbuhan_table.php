...
class BorangPermitPeniagaTumbuhanTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('borang_permit_peniaga_tumbuhan', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('jenis_tumbuhan_diniaga')->nullable();
            $table->string('butir_lesen_permit_terdahulu')->nullable();
            $table->dateTime('tarikh_penyata_terakhir')->nullable();
            //salinan penyata terakhir/terbaru in file table
    ...
    {
        Schema::dropIfExists('borang_permit_peniaga_tumbuhan');
    }
}
